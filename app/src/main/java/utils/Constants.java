...
public class Constants {
    ...
    public static final String API_NOTICE = API_URL + "/notice";

    public static final String USER_ACCESS_CATS = "access_cat";
    ...
    public static final String ROOT_IMG_PATH = "/images/uploaded";
